...
private:
  ...
  int ACTIVE_ATK_TIME = 250; // time will take for ligh to reach max brightness
  int ACTIVE_RLS_TIME = 500; // time will take for ligh to reach min brightness

  //2020-09-29 added some new timing variables to be used
  // in stanby mode (see main loop)
  int STANDBY_ATK_TIME = 1000; // time will take for ligh to reach max brightness
  int STANDBY_RLS_TIME = 1000; // time will take for ligh to reach min brightness
  ...
  float ACTIVE_BRIGHTNESS = 0.9;
  //2020-09-29 added a new brightness variable be used
  // in stanby mode (see main loop)
  float STANDBY_BRIGHTNESS = 0.5;
...
public:
  ...
  void setActiveBrightnessAndTimes();
  void setStandbyBrightnessAndTimes();
};

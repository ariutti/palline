// Palline v5
// new version of the simulation of the Aboca Palline exhibit.
// I've used this simulation to develop the standby part.
...
// ball triggerings.
long TIME_BETWEEN_STANDBY_TRIGGERING_MIN = 100; // ms
long TIME_BETWEEN_STANDBY_TRIGGERING_MAX = 250; // ms
